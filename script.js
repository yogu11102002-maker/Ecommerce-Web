...
function displayProducts(category) {
    ...
    // Agar page me products section hi nahi hai to function band
...
if (productSection) {
    ...
    else if (document.body.classList.contains("fashion-page")) {

        displayProducts("fashion");

    }

    else if (document.body.classList.contains("beauty-page")) {

        displayProducts("beauty");

    }

    else if (document.body.classList.contains("electronics-page")) {

        displayProducts("electronics");

    }

    else if (document.body.classList.contains("home-kitchen-page")) {
